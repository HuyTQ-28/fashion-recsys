...
DEFAULT_DATA_PATH = os.path.abspath(
    os.path.join(os.path.dirname(__file__), '..', '..', '..', 'FREEDOM')
)
...
def parse_args():
    ...
    parser.add_argument('--data_path', nargs='?', default=DEFAULT_DATA_PATH,
                        help='Input data root or dataset directory.')
    parser.add_argument('--seed', type=int, default=123,
                        help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='hm',
                        help='Dataset name, e.g. hm for FREEDOM/hm/hm.inter')
    ...
    parser.add_argument('--eval_batch_size', type=int, default=0,
                        help='Evaluation user batch size. 0 uses --batch_size.')
    parser.add_argument('--eval_cores', type=int, default=0,
                        help='Number of CPU worker processes for evaluation. 0 uses all available CPUs.')
    ...
    parser.add_argument('--valid_k', type=int, default=20,
                        help='K used for early stopping validation recall.')
