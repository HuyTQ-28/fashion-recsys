...
class Config(object):
    ...
    def _load_dataset_model_config(self, config_dict):
        ...
        cur_dir = os.path.join(self.source_dir, 'configs')
    ...
    def _set_path_parameters(self):
        ...
        if not os.path.isabs(data_path):
            data_path = os.path.abspath(os.path.join(self.source_dir, data_path))
        dataset_path = os.path.join(data_path, self.final_config_dict['dataset'])
        if not os.path.isdir(dataset_path):
            dataset_path = data_path

        self.final_config_dict['data_path'] = data_path
        self.final_config_dict['dataset_path'] = dataset_path
